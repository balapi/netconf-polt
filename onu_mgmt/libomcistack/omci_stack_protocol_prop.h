 ...
 */
#define BCM_OMCI_OBJ_ATTR_NAME_GET(_me_obj_type, _me_attr) \
    ((_me_obj_type >= BCM_OMCI_OBJ_ID__NUM_OF || _me_attr >= BCM_OMCI_MAX_ATTR_COUNT_IN_ME) \
    ? "*UNKNOWN*" \
    : me_and_attr_properties_arr[(_me_obj_type)].me_attr_properties[_me_attr].attr_name)
