 ...
 * \returns BCM_ERR_OK if all OK, BCM_ERR_OVERFLOW if outbuff not big enough
 */
bcmos_errno b64_encode ( const unsigned char *inbuff,
 ...
 * \return BCM_ERR_OK if all OK
 *         BCM_ERR_OVERFLOW if outbuff not big enough
 */
