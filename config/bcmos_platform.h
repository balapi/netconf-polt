...
typedef enum
{
    ...
    /* ITU stress user application (To support multiple devices we need to add number of devices to previous value) */
    BCMOS_MODULE_ID_USER_APPL_ITU_STRESS_DEV0 = BCMOS_MODULE_ID_USER_APPL_ITU_MAC_LEARNING_DEV0 + BCMTR_MAX_DEVICES,

    /* ITU multi-PON DBA stress user application (To support multiple devices we need to add number of devices to previous value) */
    BCMOS_MODULE_ID_USER_APPL_ITU_MULTI_PON_DBA_STRESS_DEV0 = BCMOS_MODULE_ID_USER_APPL_ITU_STRESS_DEV0 + BCMTR_MAX_DEVICES,

    /* ITU DS OMCI packets user application (To support multiple devices we need to add number of devices to previous value) */
    BCMOS_MODULE_ID_USER_APPL_ITU_DS_OMCI_DEV0 = BCMOS_MODULE_ID_USER_APPL_ITU_MULTI_PON_DBA_STRESS_DEV0 + MAX_NUMBER_OF_PONS_ON_ALL_DEVICES,
    ...
    /* ITU statistics (To support multiple devices we need to add number of devices multiplied by max PON number to previous value) */
...
typedef enum
{
    ...
    BCMOS_MSG_ID_ITU_MULTI_PON_DBA_STRESS_START,
    BCMOS_MSG_ID_ITU_MULTI_PON_DBA_STRESS_TIMEOUT,
    BCMOS_MSG_ID_ITU_MULTI_PON_DBA_STRESS_PON_DEACTIVATION_COMPLETED,
    BCMOS_MSG_ID_ITU_MULTI_PON_DBA_STRESS_PON_ACTIVATION_COMPLETED,
    BCMOS_MSG_ID_ITU_MULTI_PON_DBA_STRESS_PON_ACTIVATE_ALL_ONUS_COMPLETED,
    BCMOS_MSG_ID_ITU_MULTI_PON_DBA_STRESS_PON_DEACTIVATE_ALL_ONUS_COMPLETED,
    BCMOS_MSG_ID_ITU_MULTI_PON_DBA_STRESS_SN_ACQUISITION_CYCLE_START,
    BCMOS_MSG_ID_ITU_MULTI_PON_DBA_STRESS_ONU_DISCOVERED,
    BCMOS_MSG_ID_ITU_MULTI_PON_DBA_STRESS_ONU_DEACTIVATION_COMPLETED,
    BCMOS_MSG_ID_ITU_MULTI_PON_DBA_STRESS_ONU_ACTIVATION_COMPLETED,
...
#define TASK_PRIORITY_USER_APPL_ITU_MULTI_PON_DBA_STRESS BCMOS_TASK_PRIORITY_12
